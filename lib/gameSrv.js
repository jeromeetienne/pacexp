...
WebyMaze.GameSrv.prototype.tick		= function(){
	...
	this.pills.forEach(function(shoot){
		pills.tick();
	}.bind(this))
	...
	this.players.forEach(function(player, i){
		this.pills.forEach(function(pills){
			var collision	= collisionUtils.collideSphere(player.position, player.bodyWidth, pills.position, pills.bodyWidth);
			if( !collision )	return;
