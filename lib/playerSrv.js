...
// TODO split this function
	...
	this.ioClient.on('disconnect', function(){
		console.log("sessionId", this.ioClient.id)
...
{
	console.log("PlayerSrv", this.username, "destroy id", this.ioClient.id)
	console.dir(Object.keys(this.ioClient))
