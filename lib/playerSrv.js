...
// TODO split this function
	...
	// init syncRotZ
	var AngleSync	= require('./angleSync.js');
	if( true ){
	...
	this._config	= require('./configSrv.js').playerSrv;
...
WebyMaze.PlayerSrv.prototype.tick	= function()
{
	...
	var controlType	= this._config.controlType;
//controlType	= 'freeRelative';
	if( controlType === 'cardinalAbsolute' ){
		return this.controlCardinalAbsolute();
	}else if( controlType === 'guidedRelative' ){
		return this.controlGuidedRelative();
	}else if( controlType === 'freeRelative' ){
		return this.controlFreeRelative();
...
*/
WebyMaze.PlayerSrv.prototype.controlCardinalAbsolute	= function()
{
	...
	return this.controlAbsolute(wishes)
}

WebyMaze.PlayerSrv.prototype.controlGuidedRelative	= function()
{
	var keys	= {
 ...
 * - remember until either keyup or can do it
*/
WebyMaze.PlayerSrv.prototype.controlAbsolute	= function(wishes)
{
	// define angle constant
	var angle	= {
		east	: -Math.PI/2,
...
WebyMaze.PlayerSrv.prototype.controlFreeRelative	= function(){
	// TODO make the speed depends on the time between ticks
