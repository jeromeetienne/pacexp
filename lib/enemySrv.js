...
WebyMaze.EnemySrv.prototype._cpuNewDirectionRandom	= function()
{
	...
	var cardDir	= require('./tmp/mapUtils').distMapMazeSrv2ShortestDir(this.maze, srcX, srcY, dstX, dstY);
	////var cardDir	= require('./tmp/mapUtils').distMapMazeSrv2ShortestDir(this.maze, this.maze.mapH()-1-srcY, this.maze.mapW()-2-srcX, 1, 1);
...
//curDir	= null;
	...
	var MapUtils2	= require('./tmp/mapUtils2');
	//var cardDir	= require('./tmp/mapUtils').distMapMazeSrv2ShortestDir(this.maze, srcX, srcY, targetTile.x, targetTile.y);
