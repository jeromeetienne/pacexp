...
console.log("playerX", playerX, "playerY", playerY)
	...
	//if( this.stage === 'chase' ){
		...
		if( this.enemyType === 'blinky' )	return { x: playerX, y: playerY };
		else if( this.enemyType === 'pinky' )	return { x: 1, y: 17 };
		else if( this.enemyType === 'inky' )	return { x: 20, y: 1 };
		else if( this.enemyType === 'clyde' )	return { x: 20, y: 17 };
